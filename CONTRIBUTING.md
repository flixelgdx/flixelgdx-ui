# Contributing to FlixelGDX UI

FlixelGDX UI follows the exact same contribution guidelines as the main framework. Rather than
...
The only thing specific to this repository is how you build and test the UI extension locally,
...
For this repository's own AI-assistant instructions, including the UI-specific design rules, see
**[AGENTS.md](AGENTS.md)**.
